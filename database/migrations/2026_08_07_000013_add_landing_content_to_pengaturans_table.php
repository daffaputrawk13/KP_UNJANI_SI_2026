...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('pengaturans', function (Blueprint $table) {
            $table->string('hero_eyebrow')->nullable()->after('logo_path');
            $table->string('hero_judul_awal')->nullable()->after('hero_eyebrow');
            $table->string('hero_judul_aksen')->nullable()->after('hero_judul_awal');
            $table->string('hero_subjudul')->nullable()->after('hero_judul_aksen');
            $table->text('hero_deskripsi')->nullable()->after('hero_subjudul');
            $table->string('hero_image_path')->nullable()->after('hero_deskripsi');
            $table->json('fitur')->nullable()->after('hero_image_path');
            $table->text('tentang_deskripsi')->nullable()->after('fitur');
            $table->string('tentang_moto_judul')->nullable()->after('tentang_deskripsi');
            $table->text('tentang_moto_deskripsi')->nullable()->after('tentang_moto_judul');
            $table->string('website')->nullable()->after('telepon_kontak');
            $table->json('sosial_media')->nullable()->after('website');
        });

        // Isi nilai default supaya tampilan landing page tidak berubah sampai
        // admin benar-benar mengedit lewat "Pengaturan Umum".
