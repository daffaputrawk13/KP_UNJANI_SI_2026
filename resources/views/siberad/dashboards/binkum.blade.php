...
<div class="shell">
  ...
  <main class="main">
    <div class="topbar">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div>
          ...
          <div class="topbar-sub">Binkum (Pembinaan Umum) &middot; Pengawasan satuan, lomba internal, personel baru</div>
        </div>
      </div>
    ...
    <div class="content">
      <div class="notice"><b>Catatan:</b> Halaman ini adalah prototype tampilan peran Binkum. Sesuai rapat KP Pussiberad, tugas satuan ini adalah <b>pengawasan terhadap satuan</b>, penyelenggaraan <b>lomba internal</b>, dan verifikasi personel baru.</div>
