...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="side-unit">
      ...
      <div class="name">Satlak Penindakan</div>
    </div>
    <nav class="side-nav">
  ...
  <main class="main">
    <div class="topbar">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div>
          ...
          <div class="topbar-sub">Satlak Penindakan &middot; Penanganan aksi cyber: malware, ransomware, serangan</div>
        </div>
      </div>
    ...
    <div class="content">
      <div class="notice"><b>Catatan:</b> Halaman ini adalah prototype tampilan peran Satlak Penindakan. Sesuai rapat KP Pussiberad, tugas satuan ini adalah menangani <b>aksi-aksi cyber</b> seperti malware, ransomware, dan serangan lain terhadap sistem.</div>
