      ...
      <section class="tab-panel active" data-tab-panel="ringkasan">
        ...
        <div class="stat-grid">
          <div class="stat-card">
            ...
            <div class="val"><?php echo e($stats['satlak_dikoordinasikan']); ?></div>
            <div class="sub">Satuan pelaksana</div>
          </div>
          <div class="stat-card">
            <div class="lbl">Laporan Diteruskan</div>
            <div class="val" style="color:var(--green);"><?php echo e($stats['laporan_diteruskan']); ?></div>
            <div class="sub">Ke WADAN/DANPUS</div>
          </div>
          <div class="stat-card">
            <div class="lbl">Koordinasi Aktif</div>
            <div class="val" style="color:var(--amber);"><?php echo e($stats['permintaan_koordinasi_aktif']); ?></div>
            <div class="sub">Sedang berjalan</div>
          </div>
          <div class="stat-card">
            <div class="lbl">Menunggu WADAN</div>
            <div class="val" style="color:var(--amber);"><?php echo e($stats['menunggu_wadan']); ?></div>
        ...
        <div class="panel">
          <div class="tbl-wrap">
            <table class="dtbl">
              ...
              <tbody>
                <?php $__currentLoopData = $koordinasiSatlak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($k['satuan']); ?></td>
                  <td><?php echo e($k['perihal']); ?></td>
                  <td style="color:var(--text-muted);"><?php echo e($k['jenis']); ?></td>
                  <td><?php echo e($k['tanggal']); ?></td>
                  <td><span class="status-dot <?php echo e($k['status_class']); ?>"><?php echo e($k['status']); ?></span></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
        ...
        <div class="panel">
          <div class="tbl-wrap">
            <table class="dtbl">
              ...
              <tbody>
                <?php $__currentLoopData = $laporanDiteruskan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($l['satuan']); ?></td>
                  <td><?php echo e($l['perihal']); ?></td>
                  <td><?php echo e($l['tanggal']); ?></td>
                  <td style="color:var(--text-muted);"><?php echo e($l['diteruskan_ke']); ?></td>
            ...
            <form class="form-grid" onsubmit="event.preventDefault(); alert('Prototype — form ini belum tersambung ke database.');">
              <div class="form-field">
                ...
                <select id="satuanLapor">
                  <?php $__currentLoopData = $koordinasiSatlak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option><?php echo e($k['satuan']); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
              <div class="form-field">
...
</html><?php /**PATH D:\SEMESTER 6\KP PUSSIBERAD\KP_UNJANI_SI_2026\resources\views/siberad/dashboards/sdir.blade.php ENDPATH**/ ?>