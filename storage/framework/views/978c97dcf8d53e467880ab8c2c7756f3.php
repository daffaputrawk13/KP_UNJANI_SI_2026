...
<body>
  <header class="topbar-simple">
    <div class="logo"><img src="<?php echo e(asset('images/logo-pussiberad.jpg')); ?>" alt="Lambang Pussiberad">SIBER<span>AD</span></div>
  ...
  <main>
    <div class="card hud-panel">
      ...
      <h1 style="margin-top:14px;">Selamat datang, <?php echo e($user->name); ?></h1>
      <span class="badge"><?php echo e($satuan?->kategori ?? '—'); ?></span>
      <p class="meta" style="margin-top:14px;">
        Anda login sebagai <strong style="color:var(--text);"><?php echo e($satuan?->nama ?? 'Tidak diketahui'); ?></strong>
        (<?php echo e($satuan?->kode); ?>) &middot; Jabatan: <?php echo e($user->jabatan ?? '-'); ?>
      ...
      <div class="stat-grid" style="margin-top:24px;">
        <div class="stat-card">
          ...
          <div class="val" style="font-size:16px;"><?php echo e($satuan?->nama ?? '-'); ?></div>
        </div>
        <div class="stat-card">
        ...
        <div class="stat-card">
          ...
          <div class="val" style="font-size:16px;"><?php echo e($user->jabatan ?? '-'); ?></div>
        </div>
      </div>
...
<?php /**PATH D:\Unjani\Kerja Praktek\kelompok5\KP_UNJANI_SI_2026\resources\views/siberad/dashboards/generic.blade.php ENDPATH**/ ?>