            ...
            <table class="dtbl">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e($l['waktu']); ?></td>
                  <td><?php echo e($l['hasil']); ?></td>
                  <td><span class="status-dot <?php echo e($l['status_class']); ?>"><?php echo e($l['status']); ?></span></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </tbody>
            </table>
...
(function () {
  ...
  var proyekRiset = <?php echo json_encode($proyekRiset, 15, 512) ?>;
  var kategoriDistribusi = <?php echo json_encode($kategoriDistribusi, 15, 512) ?>;
  var perbandinganSatlak = <?php echo json_encode($perbandinganSatlak, 15, 512) ?>;
...
</html><?php /**PATH D:\Unjani\Kerja Praktek\kelompok5\KP_UNJANI_SI_2026\resources\views/siberad/dashboards/satlakbangtek.blade.php ENDPATH**/ ?>