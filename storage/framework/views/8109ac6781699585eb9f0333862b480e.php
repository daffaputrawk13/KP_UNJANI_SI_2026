<script>
  ...
  function terapkanRowLimit(panel) {
    if (!panel) return;
    panel.querySelectorAll('[data-row-limit]').forEach(function (wrap) {
...
</script><?php /**PATH D:\SEMESTER 6\KP PUSSIBERAD\SISTEM_baru\resources\views/siberad/dashboards/partials/dash-script.blade.php ENDPATH**/ ?>